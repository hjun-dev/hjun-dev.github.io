...
이 시리즈는 특정 응용이나 구현을 목적으로 하지 않으며 
강의 내용을 따라가면서 최적화 이론을 정리하는 데 초점을 둡니다.
...
강의의 흐름을 따라가며 꾸준히 정리하는 것이 목표입니다. 이 기록이 이후 최적화 이론을 다시 공부하거나 논문을 읽을 때 참고할 수 있는 개인적인 정리 노트로 남기를 바랍니다. 
